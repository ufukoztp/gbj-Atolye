...
class WaitingOrderListWidgets extends StatefulWidget {
  final OrderListProvider orderListProvider;
  final UseCases useCase;

  const WaitingOrderListWidgets({
  ...
  @override
  _WaitingOrderListWidgetsState createState() => _WaitingOrderListWidgetsState();
}

class _WaitingOrderListWidgetsState extends State<WaitingOrderListWidgets> {
      ...
      child: Scaffold(
        body: Stack(
          ...
          children: <Widget>[
            ...
            Visibility(
              visible:
                  !widget.orderListProvider.isLoading,
              child: RefreshWidget(
                onRefresh: ()async{
            ...
            Visibility(
              visible: widget.orderListProvider.waitingNoProduct &&
                  !widget.orderListProvider.isLoading,
              child: Container(
                  padding: EdgeInsets.all(10.0),
                  alignment: Alignment.center,
                  child: Text(
                    AppLocalizations.of(widget.orderListProvider.context).txtLblNoWaitingProduct,
  ...
  List<Widget> getList() {
    setState(() {
     ...
     List<Widget> widgets = List<Widget>();
       for (OrderList order in widget.orderListProvider.getWaitingOrderList())
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                ...
                InkWell(
                  onTap: (){
                    Navigator.of(orderListProvider.context).push( MaterialPageRoute(builder: (context)=>DetailPhotoPreviewScreen(order.products[position].variants[0].images[0].image)));
                  ...
                  child: Container(
                    ...
                    child: CachedNetworkImage(
                      imageUrl: order.products[position].variants[0].images[0].image ,
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Text(
                              order.products[position].jewelryType.name.toUpperCase()+' '+order.products[position].jewelryType.parentName.toUpperCase(),
            ...
            Stack(children: [
              ...
              Visibility(
                  ...
                  child: InkWell(
                      ...
                      child: Icon(Icons.chevron_right,color: AppTheme.collectionPageColor[50],))),
          ...
          new Container(
            ...
            child: new Container(
                decoration: new BoxDecoration(
                    color:  order.products[position].orderStatus == 0 ? AppTheme.safetyOrange[50] : AppTheme.darkRed[50],
                    borderRadius:
                    new BorderRadius.all(const Radius.circular(10.0))),
                child: Padding(
                  padding: EdgeInsets.all(4.0),
                  child: new Text(
                    order.products[position].orderStatus == 0
                        ? AppLocalizations.of(orderListProvider.context).txtTabsWaitingOrders
                        : AppLocalizations.of(orderListProvider.context).txtTabsProblematicOrders,
                    style: TextStyle(
                        color: AppTheme.white[50],
                        fontSize: 13.0,
                        fontFamily: 'MontserratBold'),
