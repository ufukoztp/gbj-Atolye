...
//orderListProvider.getProductionOrderList()

class ProductionOrderListWidgets extends StatefulWidget {

  final OrderListProvider orderListProvider;
  final UseCases useCase;

  const ProductionOrderListWidgets({
  ...
  @override
  _ProductionOrderListWidgetsState createState() => _ProductionOrderListWidgetsState();
}

class _ProductionOrderListWidgetsState extends State<ProductionOrderListWidgets> {
    ...
    return DefaultStickyHeaderController(
      child: Scaffold(
        body: Stack(
          ...
          children: <Widget>[
            Visibility(
              visible: !widget.orderListProvider.productionNoProduct && !widget.orderListProvider.isLoading,
              child: RefreshWidget(
                onRefresh: ()async{
            ...
            Visibility(
              ...
              child:Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(
                      AppLocalizations.of(widget.orderListProvider.context).txtLblNoManufacturingProduct,
  ...
  List<Widget> getList() {
    ...
    for (OrderList order in widget.orderListProvider.getProductionOrderList())
  ...
  Widget _cardTemp(position,context) {
    return Padding(
        ...
        child: Container(
          ...
          child: InkWell(
            onTap: () {
              orderListProvider.changeOrderProductSelectedStatus(order.products[position]);
            },
              child: Container(
                decoration: BoxDecoration(
                  color: Colors.white,
        ...
        new Container(
          ...
          child: new Container(
              decoration: new BoxDecoration(
                  color: AppTheme.darkGreen[50],
                  borderRadius:
                  new BorderRadius.all(const Radius.circular(10.0))),
              child: Padding(
                padding: EdgeInsets.all(4.0),
                child: new Text(
                  AppLocalizations.of(orderListProvider.context).txtTabsManufacturingOrders,
                  style: TextStyle(
                      color: AppTheme.white[50],
                      fontSize: 13.0,
                      fontFamily: 'MontserratBold'),
