...
Future<int> asyncMinOrderQuentityInputDialog({BuildContext context,int minOrderQ}) async {


  var controller = new TextEditingController(text: minOrderQ.toString()==0?" ": minOrderQ.toString());
  ...
  return showDialog<int>(
    ...
    builder: (BuildContext context) {
      ...
      return AlertDialog(
          ...
          title: Text("Minimum Satış Adeti",
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  autofocus: true,
                  onChanged: (value) {
                    minOrderQ = int.parse(controller.text);
                  },
                ),
              ),
                  ...
                  children: <Widget>[
                    Expanded(
                        child: InkWell(
                          ...
                          onTap: () {
                            Navigator.of(context).pop(minOrderQ);
                          },
                        )),
                  ],
                ),
