  ...
  Future sendApprovalState(BuildContext context) async {
    if(widget.requestType==OtherOptionsType.availableOptions){
      ...
      _productDetailProvider.sendApproval().then((value) async{
        ...
        if(value==true){
          _productDetailProvider.availableSpects=_productDetailProvider.personalizeOptions;
          _productDetailProvider.availableOtherOptions=_productDetailProvider.otherOptionGroups;
